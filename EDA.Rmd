...
eval_metrics(OLS_model, train, predictions, target = 'price_doc')

#predicting and evaluating the model on test data
predictions = predict(OLS_model, newdata = test)
eval_metrics(OLS_model, test, predictions, target = 'price_doc')
...
ggplot(moddata, aes(price, full_sq+floor)) +
  geom_point() +
  stat_smooth(method = lm)

df_numeric$price_doc
